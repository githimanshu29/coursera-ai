...
const Landing = () => {
  ...
  const features = [
    {
      ...
      description:
        "Transform any topic into a structured curriculum with AI-powered content generation in seconds.",
      color: "#a78bfa",
      delay: "0.1s",
    },
    {
      ...
      description:
        "Each chapter includes curated YouTube videos automatically fetched to enhance your learning.",
      color: "#60a5fa",
      delay: "0.2s",
    },
    {
      ...
      description:
        "AI-generated rich HTML content for every topic, formatted for maximum readability and depth.",
      color: "#34d399",
      delay: "0.3s",
    },
    {
      ...
      description:
        "Track completed topics and chapters with a visual progress bar that updates in real-time.",
      color: "#f59e0b",
      delay: "0.4s",
    },
    {
      ...
      description:
        "Visual timeline of your entire course structure — chapters, topics, and learning path at a glance.",
      color: "#f472b6",
      delay: "0.5s",
    },
    {
      ...
      description:
        "Choose your difficulty level, category, and chapter count. AI adapts the course to your goals.",
      color: "#a78bfa",
      delay: "0.6s",
    },
  ];
  ...
  const comingSoon = [
    {
      ...
      description:
        "Practice real interviews with an AI that speaks, listens, and gives instant feedback on your answers.",
      tag: "COMING SOON",
      color: "#a78bfa",
      delay: "0.1s",
    },
    {
      ...
      description:
        "Ask questions about any topic mid-lesson. Gemini answers scoped to exactly what you're studying.",
      tag: "COMING SOON",
      color: "#60a5fa",
      delay: "0.2s",
    },
    {
      icon: "🧠",
      title: "Chapter Quiz System",
      description:
        "Test your knowledge with AI-generated MCQs after each chapter. Track your score and improve.",
      tag: "COMING SOON",
      color: "#34d399",
      delay: "0.3s",
    },
    {
      ...
      description:
        "Upload your resume and get AI-powered feedback, skill gap analysis, and improvement suggestions.",
      tag: "COMING SOON",
      color: "#f59e0b",
      delay: "0.4s",
    },
  ...
  return (
    ...
    >
        ...
        >
          ...
          >
            ...
            <span
              style={{
                background:
                  "linear-gradient(135deg, #a78bfa, #7c3aed, #60a5fa)",
          ...
          >
            Transform any topic into a comprehensive course with structured
            chapters, rich AI-generated content, and curated videos. Your
            personalized learning journey starts here.
          </p>
      ...
      <section
        ref={statsRef}
        style={{ padding: "0 24px 80px", maxWidth: "1200px", margin: "0 auto" }}
      >
        <div
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          ...
          <div className="steps-grid" style={{ display: "grid", gap: "20px" }}>
            <StepCard
              ...
              description="Enter any subject you want to master — from quantum physics to digital marketing, SQL to football tactics."
              delay="0.1s"
            />
            <StepCard
              number="02"
              title="AI Generates Course"
              description="Our AI structures chapters, writes comprehensive content, and curates relevant YouTube videos for each topic."
              delay="0.2s"
            />
            <StepCard
              number="03"
              title="Start Learning"
              description="Dive into your personalized course, track your progress, and master new skills chapter by chapter."
              delay="0.3s"
            />
          </div>
        </div>
      ...
      >
        ...
        >
          © 2025 Learnova · Built with ❤️ and Gemini AI
        </p>
      </footer>
    </div>
  );
