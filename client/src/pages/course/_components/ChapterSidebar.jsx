...
const ChapterSidebar = ({ course, enrollment, activeChapterIndex, activeTopicIndex, onTopicClick, isOpen, onClose, isMobile }) => {
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "14px" }}>
            ...
            <div>
              <p style={{ color: "#6b7280", fontSize: "10px", marginBottom: "2px" }}>Course Content</p>
              <p style={{ color: "white", fontSize: "13px", fontWeight: "600" }}>
                {course?.courseJson?.chapters?.length} Chapters
              </p>
            </div>
          </div>
            ...
            return (
              <div key={chIndex} style={{ marginBottom: "4px" }}>
                ...
                <div style={{
                  ...
                  padding: "10px 12px",
                  borderRadius: "10px",
                  background: isActiveChapter ? "rgba(124,58,237,0.15)" : "transparent",
                  cursor: "pointer",
                  ...
                  <div style={{
                    ...
                    color: isActiveChapter ? "white" : "#6b7280",
                  ...
                  <p style={{
                    color: isActiveChapter ? "white" : "#9ca3af",
                    fontSize: "12px", fontWeight: isActiveChapter ? "600" : "400",
                    lineHeight: "1.4",
                  }}>
                    {chapter.chapterName}
                  </p>
                ...
                {/* topics list — show when chapter is active */}
                {isActiveChapter && (
                  <div style={{ paddingLeft: "12px", marginTop: "2px" }}>
                    {chapter.topics?.map((topic, tIndex) => {
                      const isActiveTopic = tIndex === activeTopicIndex;
                      const topicKey = `${chIndex}_${tIndex}`;
                      const isCompleted = enrollment?.completedTopics?.includes(topicKey);

                      return (
                        <div
                          key={tIndex}
                          onClick={() => handleTopicClickInternal(chIndex, tIndex)}
                          style={{
                            display: "flex", alignItems: "center", gap: "8px",
                            padding: "8px 12px",
                            borderRadius: "8px",
                            cursor: "pointer",
                            background: isActiveTopic ? "rgba(124,58,237,0.1)" : "transparent",
                            transition: "background 0.2s",
                            marginBottom: "2px",
                          }}
                          onMouseEnter={(e) => {
                            if (!isActiveTopic) e.currentTarget.style.background = "rgba(255,255,255,0.03)";
                          }}
                          onMouseLeave={(e) => {
                            if (!isActiveTopic) e.currentTarget.style.background = "transparent";
                          }}
                        >
                          ...
                          <span style={{
                            color: isActiveTopic ? "white" : isCompleted ? "#a78bfa" : "#6b7280",
                            fontSize: "11px",
                            lineHeight: "1.4",
                          }}>
                            {topic}
