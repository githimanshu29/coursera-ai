...
const ChapterSidebar = ({ course, enrollment, activeChapterIndex, activeTopicIndex, onTopicClick }) => {
          ...
          return (
            <div key={chIndex} style={{ marginBottom: "4px" }}>
              ...
              <div style={{
                ...
                onClick={() => onTopicClick(chIndex, 0)}
                >
                <div style={{
                ...
                <div style={{ paddingLeft: "12px", marginTop: "2px" }}>
                  {chapter.topics?.map((topic, tIndex) => {
                    ...
                    return (
                      <div
                        key={tIndex}
                        onClick={() => onTopicClick(chIndex, tIndex)}
                        style={{
