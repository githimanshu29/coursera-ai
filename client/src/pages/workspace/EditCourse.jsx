...
const EditCourse = () => {
  ...
  const handleGenerateContent = async () => {
    ...
    setBuildLogs((prev) => [
      ...prev,
      { type: "status", message: "Starting full course generation..." },
      {
        type: "status",
        message: `Model: ${modelProvider.toUpperCase()} — ${modelName}`,
      },
    ]);
    try {
      ...
      >
        ...
        <div style={{ flex: 1, width: "100%" }}>
          ...
          {buildNotice && (
            ...
            >
              <span>{buildNotice} or use build step by step.</span>
              <button
                onClick={() =>
      ...
      {buildLogs.length > 0 && (
        <div style={{ marginBottom: "32px" }}>
          <LiveBuildWindow
            ...
            currentChapter={0}
            totalChapters={course?.courseJson?.chapters?.length || 0}
            title="learnova — full course builder"
            showProgress={false}
          />
        </div>
      )}
      ...
      <div>
        ...
        <div
          style={{
            marginBottom: "48px",
            textAlign: "center",
            animation: "edit-fadeIn 0.6s ease forwards",
          }}
        >
          <div
            style={{
