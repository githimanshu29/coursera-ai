  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <h1 className="roadmap-header-title" style={{
        ...
        <p className="roadmap-header-sub" style={{ color: "#6b7280", fontSize: "14px", lineHeight: "1.6" }}>
          {course?.courseJson?.chapters?.length} chapters · Your structured learning path
        </p>
      </div>
      ...
      <div style={{ position: "relative" }}>
          ...
          return (
            <div
              ...
              style={{
                ...
                gap: useLinearLayout ? "12px" : "80px",     /* 80 = room for the center node */
              ...
              {!useLinearLayout && (
                <>
                  ...
                  <div style={{
                    ...
                    alignItems: "flex-end",       /* right-align content to hug center */
                    paddingRight: "20px",
                  }}>
                    {isLeft ? (
                      ...
                      /* Topics on left */
                      <div className="roadmap-topics-col" style={{
                        width: "100%", maxWidth: "380px",
                        display: "flex", flexDirection: "column", gap: "8px",
                        paddingTop: "6px",
                      }}>
                        {chapter.topics?.map((topic, j) => (
                          <TopicItem key={j} topic={topic} index={j} chapterIndex={i} side="left" />
                        ))}
                      </div>
                    )}
                  </div>
                  ...
                  <div style={{
                    display: "flex", flexDirection: "column", gap: "8px",
                    alignItems: "flex-start",     /* left-align content to hug center */
                    paddingLeft: "20px",
                  }}>
                    {isLeft ? (
                      /* Topics on right */
                      <div className="roadmap-topics-col" style={{
                        ...
                        {chapter.topics?.map((topic, j) => (
                          <TopicItem key={j} topic={topic} index={j} chapterIndex={i} side="right" />
                        ))}
                      </div>
                    ) : (
        ...
        <div style={{
          ...
          <div style={{
            ...
            display: "flex", alignItems: "center", justifyContent: "center",
            fontSize: "26px",
            boxShadow: "0 0 0 5px rgba(10,15,30,1), 0 0 30px rgba(16,185,129,0.35)",
            zIndex: 3,
          }}>
            🎉
          </div>
          ...
          <p style={{
            ...
            textAlign: "center", maxWidth: "260px", lineHeight: "1.5",
          }}>
            You've previewed the full course. Start learning to track your progress!
          </p>
